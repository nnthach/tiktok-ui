...
export const UploadIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}>
        <path
...
export const FollowingActiveIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        fill="currentColor"
        className={cx('following-icon')}
        width={width}
